            ...
            <div>
                ...
                <div className="max-w-4xl  mx-auto bg-white border border-gray-200 rounded-2xl my-5 p-8">
                    <div className="flex justify-between">
                        ...
                        <Button onClick={() => setOpen(true)} varint='outline' className='text-right'>
                            <Pen />
                        </Button>
                    </div>
                    ...
                    <div className="grid w-full max-w-sm items-center gap-1.5">
...

                        {
                            isResume ? <a
                                ...
                                download
                                className="text-blue-500 w-full hover:outline cursor-pointer">
                                {user?.profile?.resumeOriginalName}</a> : <span>NA</span>
                        }

                    </div>
                </div>
                {/* appliend job section */}
                <div className="max-w-4xl mx-auto bg-white rouded-2xl">
